...
const matchSelectedCat = async (req, res) => {
    try{
        ...
        //     monthly_budget === ''
        // ) {
        //     errors.push('กรุณาระบุงบประมาณต่อเดือน');
        // }
        ...
        // if(
        //     space_level &&
        //     levelToNumber(space_level) === 0) {
        //     errors.push('ระดับพื้นที่ไม่ถูกต้อง');
        // }

        // if(
        //     attention_level &&
        //     levelToNumber(attention_level) === 0) {
        //     errors.push('ระดับเวลาดูแลไม่ถูกต้อง');
        // }

        // if(
        //     experience_level &&
        //     levelToNumber(experience_level) === 0) {
        //     errors.push('ระดับประสบการณ์ไม่ถูกต้อง');
        // }
